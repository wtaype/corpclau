 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ro=new hu("@firebase/auth");function cg(n,...e){Ro.logLevel<=Ie.WARN&&Ro.warn(`Auth (${mi}): ${n}`,...e)}function mo(n,...e){Ro.logLevel<=Ie.ERROR&&Ro.error(`Auth (${mi}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eh(n){const e=ar(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function HT(n,e,t){const r=ar(n);await Do(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Yg)}async function zT(n,e,t){if(kt(n.app))return Promise.reject(vn(n));const r=ar(n),c=await Do(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",rm).catch(_=>{throw _.code==="auth/password-does-not-meet-requirements"&&Eh(n),_}),p=await xr._fromIdTokenResponse(r,"signIn",c);return await r._updateCurrentUser(p.user),p}function WT(n,e,t){return kt(n.app)?Promise.reject(vn(n)):om(Ye(n),yi.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Eh(n),r})}async function GT(n,e){const t=Ye(n),i={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()},{email:a}=await Xg(t.auth,i);a!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function KT(n,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const r=Ye(n),a={idToken:await r.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},c=await ui(r,am(r.auth,a));r.displayName=c.displayName||null,r.photoURL=c.photoUrl||null;const p=r.providerData.find(({providerId:_})=>_==="password");p&&(p.displayName=r.displayName,p.photoURL=r.photoURL),await r._updateTokensIfNecessary(c)}function um(n,e,t,r){return Ye(n).onIdTokenChanged(e,t,r)}function cm(n,e,t){return Ye(n).beforeAuthStateChanged(e,t)}function QT(n,e,t,r){return Ye(n).onAuthStateChanged(e,t,r)}function XT(n){return Ye(n).signOut()}const xo="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vr=new hu("@firebase/firestore");function Yr(){return Vr.logLevel}function re(n,...e){if(Vr.logLevel<=Ie.DEBUG){const t=e.map(wu);Vr.debug(`Firestore (${_i}): ${n}`,...t)}}function In(n,...e){if(Vr.logLevel<=Ie.ERROR){const t=e.map(wu);Vr.error(`Firestore (${_i}): ${n}`,...t)}}function ci(n,...e){if(Vr.logLevel<=Ie.WARN){const t=e.map(wu);Vr.warn(`Firestore (${_i}): ${n}`,...t)}}function wu(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let r="";for(;r.length<20;){const i=Ry(40);for(let a=0;a<i.length;++a)r.length<20&&i[a]<t&&(r+=e.charAt(i[a]%62))}return r}}function Ae(n,e){return n<e?-1:n>e?1:0}function Ka(n,e){const t=Math.min(n.length,e.length);for(let r=0;r<t;r++){const i=n.charAt(r),a=e.charAt(r);if(i!==a)return Va(i)===Va(a)?Ae(i,a):Va(i)?1:-1}return Ae(n.length,e.length)}const Py=55296,ky=57343;function Va(n){const e=n.charCodeAt(0);return e>=Py&&e<=ky}function li(n,e,t){return n.length===e.length&&n.every(((r,i)=>t(r,e[i])))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mu{constructor(e,t,r,i){this.targetId=e,this.fromCache=t,this.Es=r,this.ds=i}static As(e,t){let r=be(),i=be();for(const a of t.docChanges)switch(a.type){case 0:r=r.add(a.doc.key);break;case 1:i=i.add(a.doc.key)}return new Mu(e,t.fromCache,r,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fv{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return Bd()?8:Fy(gt())>0?6:4})()}initialize(e,t){this.ps=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,i){const a={result:null};return this.ys(e,t).next((c=>{a.result=c})).next((()=>{if(!a.result)return this.ws(e,t,i,r).next((c=>{a.result=c}))})).next((()=>{if(a.result)return;const c=new hv;return this.Ss(e,t,c).next((p=>{if(a.result=p,this.Vs)return this.bs(e,t,c,p.size)}))})).next((()=>a.result))}bs(e,t,r,i){return r.documentReadCount<this.fs?(Yr()<=Ie.DEBUG&&re("QueryEngine","SDK will not create cache indexes for query:",Jr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),W.resolve()):(Yr()<=Ie.DEBUG&&re("QueryEngine","Query:",Jr(t),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.gs*i?(Yr()<=Ie.DEBUG&&re("QueryEngine","The SDK decides to create cache indexes for query:",Jr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,tn(t))):W.resolve())}ys(e,t){if(il(t))return W.resolve(null);let r=tn(t);return this.indexManager.getIndexType(e,r).next((i=>i===0?null:(t.limit!==null&&i===1&&(t=eu(t,null,"F"),r=tn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((a=>{const c=be(...a);return this.ps.getDocuments(e,c).next((p=>this.indexManager.getMinOffset(e,r).next((_=>{const v=this.Ds(t,p);return this.Cs(t,v,c,_.readTime)?this.ys(e,eu(t,null,"F")):this.vs(e,v,t,_)}))))})))))}ws(e,t,r,i){return il(t)||i.isEqual(pe.min())?W.resolve(null):this.ps.getDocuments(e,r).next((a=>{const c=this.Ds(t,a);return this.Cs(t,c,r,i)?W.resolve(null):(Yr()<=Ie.DEBUG&&re("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Jr(t)),this.vs(e,c,t,xy(i,_s)).next((p=>p)))}))}Ds(e,t){let r=new Je(af(e));return t.forEach(((i,a)=>{ea(e,a)&&(r=r.add(a))})),r}Cs(e,t,r,i){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const a=e.limitType==="F"?t.last():t.first();return!!a&&(a.hasPendingWrites||a.version.compareTo(i)>0)}Ss(e,t,r){return Yr()<=Ie.DEBUG&&re("QueryEngine","Using full collection scan to execute query:",Jr(t)),this.ps.getDocumentsMatchingQuery(e,t,tr.min(),r)}vs(e,t,r,i){return this.ps.getDocumentsMatchingQuery(e,r,i).next((a=>(t.forEach((c=>{a=a.insert(c.key,c)})),a)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+n.stack),e}class Ii extends aa{constructor(e,t,r,i){super(e,t,r,i),this.type="firestore",this._queue=new xl,this._persistenceKey=i?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new xl(e),this._firestoreClient=void 0,await e}}}function TT(n,e){const t=typeof n=="object"?n:Kl(),r=typeof n=="string"?n:Lo,i=du(t,"firestore").getImmediate({identifier:r});if(!i._initialized){const a=Dd("firestore");a&&_T(i,...a)}return i}function Ku(n){if(n._terminated)throw new ee(H.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||ET(n),n._firestoreClient}function ET(n){const e=n._freezeSettings(),t=(function(i,a,c,p){return new $y(i,a,c,p.host,p.ssl,p.experimentalForceLongPolling,p.experimentalAutoDetectLongPolling,ed(p.experimentalLongPollingOptions),p.useFetchStreams,p.isUsingEmulator)})(n._databaseId,n._app?.options.appId||"",n._persistenceKey,e);n._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(n._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),n._firestoreClient=new dT(n._authCredentials,n._appCheckCredentials,n._queue,t,n._componentsProvider&&(function(i){const a=i?._online.build();return{_offline:i?._offline.build(a),_online:a}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new ee(H.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new ee(H.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Ae(this._lat,e._lat)||Ae(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:rn._jsonSchemaVersion}}static fromJSON(e){if(Ns(e,rn._jsonSchema))return new rn(e.latitude,e.longitude)}}rn._jsonSchemaVersion="firestore/geoPoint/1.0",rn._jsonSchema={type:Xe("string",rn._jsonSchemaVersion),latitude:Xe("number"),longitude:Xe("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nE(n){n=on(n,We);const e=on(n.firestore,Ii);return mT(Ku(e),n._key).then((t=>LT(e,n,t)))}oi._jsonSchemaVersion="firestore/querySnapshot/1.0",oi._jsonSchema={type:Xe("string",oi._jsonSchemaVersion),bundleSource:Xe("string","QuerySnapshot"),bundleName:Xe("string"),bundle:Xe("string")};class ld extends NT{constructor(e){super(),this.firestore=e}convertBytes(e){return new Dt(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new We(this.firestore,null,t)}}function rE(n){n=on(n,Fr);const e=on(n.firestore,Ii),t=Ku(e),r=new ld(e);return DT(n._query),yT(t,n._query).then((i=>new oi(e,r,n,i)))}function OT(n,e,t){n=on(n,We);const r=on(n.firestore,Ii),i=xT(n.converter,e,t);return rc(r,[bT(Xu(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,jt.none())])}function iE(n,e,t,...r){n=on(n,We);const i=on(n.firestore,Ii),a=Xu(i);let c;return c=typeof(e=Ye(e))=="string"||e instanceof ua?CT(a,"updateDoc",n._key,e,t,r):ST(a,"updateDoc",n._key,e),rc(i,[c.toMutation(n._key,jt.exists(!0))])}function sE(n){return rc(on(n.firestore,Ii),[new Du(n._key,jt.none())])}function rc(n,e){return(function(r,i){const a=new Tn;return r.asyncQueue.enqueueAndForget((async()=>iT(await gT(r),i,a))),a.promise})(Ku(n),e)}function LT(n,e,t){const r=t.docs.get(e._key),i=new ld(n);return new Pr(n,i,e._key,r,new cs(t.hasPendingWrites,t.fromCache),e.converter)}function MT(){return new Yu("serverTimestamp")}(function(e,t=!0){(function(i){_i=i})(mi),ai(new Dr("firestore",((r,{instanceIdentifier:i,options:a})=>{const c=r.getProvider("app").getImmediate(),p=new Ii(new Ay(r.getProvider("auth-internal")),new Cy(c,r.getProvider("app-check-internal")),(function(v,I){if(!Object.prototype.hasOwnProperty.apply(v.options,["projectId"]))throw new ee(H.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ts(v.options.projectId,I)})(c,i),c);return a={useFetchStreams:t,...a},p._setSettings(a),p}),"PUBLIC").setMultipleInstances(!0)),Jn(Uc,jc,e),Jn(Uc,jc,"esm2020")})();const FT={apiKey:"AIzaSyDFz87uf2ts9y9x8cTOAFDuDnIRNHd2PkA",authDomain:"corpclau.firebaseapp.com",projectId:"corpclau",storageBucket:"corpclau.firebasestorage.app",messagingSenderId:"661687494529",appId:"1:661687494529:web:b653cf9b82bf53b803ea80"},hd=Gl(FT),oE=Ty(hd),aE=TT(hd),uE=(()=>{const n=[["Cielo","#0EBEFF"],["Dulce","#FF5C69"],["Paz","#29C72E"],["Mora","#7000FF"],["Futuro","#21273B"]];let e,t;const r=a=>{const c=Se(a).data("tema");if(!c)return!1;const[p,_]=c.split("|");if(!p||!_)return!1;Se("html").attr("data-theme",p);const v=Se('meta[name="theme-color"]');return v.length?v.attr("content",_):Se("<meta>",{name:"theme-color",content:_}).appendTo("head"),jT("wiTema",c,720),Se(".mtha").removeClass("mtha"),Se(a).addClass("mtha"),t=c,!0},i=async(a,c)=>{if(!(!a||!c?.displayName||!t))try{await OT(vT(a,"preferencias",c.displayName),{usuario:c.displayName,email:c.email,wiTema:t,fechaActualizacion:MT()},{merge:!0});const[p]=t.split("|");UT(`Tema ${p} guardado 🎨`)}catch(p){console.error("❌ Error guardando tema:",p)}};return(a,c)=>{Se(".witemas").html(n.map(([v,I])=>`<div class="tema" data-tema="${v}|${I}" style="background:${I}"></div>`).join(""));const p=qT("wiTema"),_=Se(`[data-tema="${p}"]`)[0]||Se(".mtha")[0]||Se("[data-tema]").first()[0];_&&r(_),Se(document).off("click.witema").on("click.witema","[data-tema]",v=>{!r(v.currentTarget)||!a||!c?.displayName||(clearTimeout(e),e=setTimeout(()=>i(a,c),50))})}})(),cE=(()=>{const n=()=>{const e=new Date;Se(".wty").text(e.getFullYear()),Se(".wtu").text(e.toLocaleString()),Se(document).off("click.infoo",".abw,.abwok").on("click.infoo",".abw,.abwok",function(){const t=this.id||"";navigator.clipboard&&t&&navigator.clipboard.writeText(t).catch(()=>{}),Se(".abwc").toggleClass("dpn")})};return Se(".wty,.wtu,.abw,.abwok").length?n():new MutationObserver(e=>e.some(({addedNodes:t})=>[...t].some(r=>r.querySelector?.(".wty,.wtu,.abw,.abwok")))&&(n(),!0)).observe(document.body,{childList:!0,subtree:!0}),n})(),lE=n=>n.length<=10?n:n.substring(0,10)+"...",hE=n=>{Se("#loading-style").length||Se("head").append('<style id="loading-style">.loading{height:1vh;background:linear-gradient(to right,#ffd105,#1e3a8a,#ffd105);background-size:200% 100%;animation:l 1.5s infinite;border-radius:3px;width:100%;position:fixed;top:0;left:0;z-index:9999}@keyframes l{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}</style>'),Se(".loading").length||Se("body").append('<div class="loading" style="display:none"></div>'),Se(".loading").toggle(!!n)},fE=n=>{const e=n==="smiletop"?"smiletop.html":"smile.html";window.location.href=new URL(e,window.location.href).toString()},dE=n=>n.toLowerCase().replace(/\s+/g,"").replace(/[^a-z0-9]/g,"");function pE(n,e="error",t=3e3){const r={success:"fa-check-circle",error:"fa-times-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},i={success:"#2E7D32",error:"#D32F2F",warning:"#F9A825",info:"#0288D1"};Se("#notificationsContainer").length||Se("body").append('<div id="notificationsContainer" style="position:fixed;top:1rem;right:1rem;z-index:9999;display:flex;flex-direction:column;gap:.5rem;"></div>');const a=Se(`
  ...
  `);Se("#notificationsContainer").append(a),requestAnimationFrame(()=>a.css({opacity:1,transform:"translateX(0)"})),a.find("button").on("click",()=>{a.css({opacity:0,transform:"translateX(20px)"}),setTimeout(()=>a.remove(),300)}),setTimeout(()=>{a.css({opacity:0,transform:"translateX(20px)"}),setTimeout(()=>a.remove(),300)},t)}const gE=n=>{const[e,t,r]=n.split("-").map(Number);return new Date(e,t-1,r)},UT=(n,e="success")=>{Se(".alert-box").remove();const t={error:{bg:"#FFE8E6",txt:"#D32F2F",border:"#FFCDD2",icon:"fa-circle-exclamation"},success:{bg:"#E8F5E9",txt:"#2E7D32",border:"#C8E6C9",icon:"fa-circle-check"}},{bg:r,txt:i,border:a,icon:c}=t[e]||t.error,p=Se(`
